...
int main(int argc , char* argv[]) {
	...
	if (fgets(general_hash, 6, hfp) == NULL) {
	...
	while ((nread = getline(&line, &len, fp)) != -1) {
		...
		pthread_create(&tid[i-1], NULL, passwcheck,(char *)line);
