...
PoliTo:OperatingSystems04JEZOQ:gv_sha256:1.0\
"
...
\
  ...
  # Create instance: gv_sha256_0, and set properties
  set gv_sha256_0 [ create_bd_cell -type ip -vlnv PoliTo:OperatingSystems04JEZOQ:gv_sha256:1.0 gv_sha256_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins gv_sha256_0/S00_AXI]

  # Create port connections
  connect_bd_net -net gv_sha256_0_activity_led [get_bd_pins gv_sha256_0/activity_led] [get_bd_ports led1]
  connect_bd_net -net gv_sha256_0_clocked_led [get_bd_pins gv_sha256_0/clocked_led] [get_bd_ports led0]
  connect_bd_net -net gv_sha256_0_sha256_irq [get_bd_pins gv_sha256_0/sha256_irq] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_76M/slowest_sync_clk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins gv_sha256_0/s00_axi_aclk]
  ...
  connect_bd_net -net rst_ps7_0_76M_peripheral_aresetn [get_bd_pins rst_ps7_0_76M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins gv_sha256_0/s00_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs gv_sha256_0/S00_AXI/S00_AXI_reg] -force
